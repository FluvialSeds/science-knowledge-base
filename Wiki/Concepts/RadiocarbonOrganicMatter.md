...
**Modern carbon** (Δ¹⁴C near 0‰):
- Recently fixed by photosynthesis
- Reflects current primary production
- Expected from aquatic phytoplankton and young leaves

**Bomb-enriched carbon** (Δ¹⁴C > 0‰):
- Enriched in ¹⁴C from atmospheric nuclear weapons testing (1950s-1960s)
- Useful marker for carbon fixed during peak bomb era
- Indicates young, surface-derived organic matter

**Pre-aged (depleted) carbon** (Δ¹⁴C < 0‰):
- Older than modern atmospheric levels
...
In large rivers, Δ¹⁴C measurements on particulate organic matter (POM) reveal:

**POM source partitioning:**
