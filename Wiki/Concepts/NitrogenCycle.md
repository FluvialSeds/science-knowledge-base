...
The nitrogen cycle is regulated by:
- **Oxygen availability**: Determines which transformations are possible (aerobic nitrification vs. anaerobic anammox/denitrification)
- **Iron and phosphorus**: Co-limit nitrogen fixation rates in many ecosystems
- **Temperature**: Affects enzyme kinetics and metabolic rates
- **Substrate availability**: NH₃, NO₂⁻, and NO₃⁻ concentrations control transformation rates
...
- **Productivity shifts**: Change the balance between nitrogen supply and demand
...
Understanding past nitrogen cycle changes helps interpret:
- How ocean [[DeepWaterAnoxia|deoxygenation]] from climate change will alter marine productivity
- Nutrient cycling in response to anthropogenic perturbations
- Linkages between nitrogen cycling, carbon burial, and atmospheric composition over geological time
